      ...
      <div className="flex space-x-5 h-[496px] mb-8">
        ...
        <div className="h-[496px] flex flex-col justify-between w-1/4 grow">
          ...
          <div className="flex space-x-3">
            <div className="h-fit rounded-lg py-2 drop-shadow-lg text-xs grid grid-rows-1 grid-flow-col gap-6 overflow-x-auto">
            ...
            <div className="h-fit py-2">
              ...
              <div className="h-[116px] w-[116px] py-3 rounded-lg bg-white font-semibold text-xs border-2 border-black">
                ...
                <button className="flex items-center text-blue-600 hover:text-purple-500 h-1/2 ">
                  ...
                  <p className="pr-3">Copy entity URL</p>
                </button>
              </div>
            </div>
          </div>
