          ...
          <div className="bg-white border border-black  sm:w-7/12 sm:mx-auto flex sm:py-0 sm:px-3 rounded-full overflow-hidden">
            <div className="sm:col-span-3 border-r">
              <select
                ...
                className="truncate text-center text-xs sm:text-sm h-full block w-20 sm:w-52 border-0 bg-transparent sm:py-2 px-3 sm:px-3 focus:border-0 focus:outline-none focus:ring-0 "
              >
