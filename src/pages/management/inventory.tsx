...
export default function Home() {
  ...
  return (
    <>
      <div className="px-3 flex items-center justify-between sm:hidden sm:pl-16 sm:h-fit py-3 sm:pt-6 sm:mt-0 sm:pb-5 bg-gray-300 w-full z-50 sm:z-0 fixed sm:relative sm:mb-0 text-2xl sm:text-2xl font-bold sm:font-bold">
              ...
              <div className="flex items-center space-x-6">
                <div className="flex pt-1 space-x-2 sm:flex-row flex-row-reverse">
                  <p className="text-xs mt-0.5 ml-2 sm:ml-0">
                    Upload your Inventory as a PDF
                  </p>
                  <ToggleButton />
                </div>
              </div>
