      ...
      <div className="flex">
        ...
        <div className="flex flex-col space-y-5 w-full">
          ...
          <div className="h-fit  bg-white rounded-lg p-4 drop-shadow-lg flex flex-col">
            ...
            <div className="flex">
              <div className="text-lg font-bold grow">Highlights</div>
              <div className="text-blue-500 flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className="flex mt-3 mb-4">
              <div className="w-1/3 text-sm font-bold">Highlight</div>
              <div className="w-1/3 text-sm font-bold">Status</div>
              <div className="w-1/3 text-sm font-bold">Pubish/Unpublish</div>
            </div>
            {/* "HIGHLIGHT ROW" */}
            <div className="divide-y space-y-6 ">
              {/* HIGHLIGHT 1 */}
              <div className="flex items-center justify-between">
                <div className=" text-sm text-gray-500">Highlight Name</div>
                ...
                <div className="flex justify-between ">
                  <div className="grow text-sm text-blue-500 ">Edit</div>
                  <div className="text-sm text-blue-500">Remove</div>
                </div>
              </div>
              {/* HIGHLIGHT 2 */}
              <div className="flex items-center justify-between">
